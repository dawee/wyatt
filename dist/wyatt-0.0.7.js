...
__tetanize_define('index.js', function (require, exports, module) { 
  ...
  wyatt.register('button', require('lib/ButtonElement.js'));
  wyatt.register('imageview', require('lib/ImageElement.js'));
  wyatt.register('textfield', require('lib/TextFieldElement.js'));
  

});
__tetanize_define('node_modules/titanium-namespace/index.js', function (require, exports, module) { 
  module.exports = typeof Titanium === 'undefined' ? require('mockti')() : Titanium;
...
__tetanize_define('lib/ViewElement.js', function (require, exports, module) { 
  ...
  ViewElement.prototype.query = function (query) {
    return this.yat.query(query);
  };
  ...
  ViewElement.prototype.any = function (query) {
    return this.yat.any(query);
  };
...
__tetanize_define('lib/TextFieldElement.js', function (require, exports, module) { 
  var Ti = require('node_modules/titanium-namespace/index.js');
  var ViewElement = require('lib/ViewElement.js');
